...
library(tidyverse)
library(here)
here::i_am("Transforming_raw_data.Rmd")
```

## Pairwise data

```{r import 2018 PW data, echo = F, warning = F, message = F}
...
```{r write out 2018 PW data, echo = F, warning = F, message = F}
...
```{r import pH 5 LOO data, echo = F, warning = F, message = F}
...
```{r write out pH 5 LOO data, echo = F, warning = F, message = F}
...
```{r import pH 7 LOO data, echo = F, warning = F, message = F}
d.loo7 <- read_csv(file = "raw_data/2020_11_17_pH7LOO - Data.csv", col_types = "ffffdddddd")
```

```{r write out pH 7 LOO data, echo = F, warning = F, message = F}
